...
val Project.globalAllScope: GlobalSearchScope
 ...
 */
fun Project.findTwineElements(): List<PsiElement> = findFiles(TwineFileType, globalAllScope)
    .map { it as TwineFile }
 ...
 * @param scope [GlobalSearchScope] where files should be searched
